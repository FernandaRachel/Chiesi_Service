...
namespace Chiesi.Reports
{
    class ReportPlacebos : IReport, IOperationState
    {
        ...
        public ReportPlacebos(EquipamentType eqtype)
        {
            ...
            op5 = new SecondLoadingClass(eqtype, "2º Carregamento de Álcool Etílico Anidro + Glicerol", "1.2", "3", false, true);
            op7 = new HighSpeedMix(eqtype, "30", "1500", "0", "0", false, false, false, "");
            op8 = new AdditionClass(eqtype, "Adição de Excipiente pelo Bocal T2", true, false);
