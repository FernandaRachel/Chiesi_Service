...
namespace Chiesi.Reports
{
    class ReportClenilCompositum : IReport, IOperationState
    {
...

        {
            ...
            op8 = new HighSpeedMix(eqtype, "30", "0", "1500", "2000", true, false, false, "5");
            ...
            op11 = new HighSpeedMix(eqtype, "30", "0", "2000", "2500", true, false, false,"20");
            ...
            //op15 = new FillingStart(eqtype, "Clenil Compositum");
