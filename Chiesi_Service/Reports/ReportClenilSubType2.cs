...
{
    class ReportClenilSubType2 : IReport
    {
        ...
        public ReportClenilSubType2(EquipamentType eqtype)
        {
            ...
            op9 = new FourthLoadingClass(eqtype, "4º Carregamento de Álcool Etílico Anidro + Glicerol", "1.2", "3",2);
            ...
            op14 = new LowSpeedMix(eqtype, "10", "30", true);
        ...
        public void StartReport()
        {
            ...
            op7.SetSuccessor(op9);
            op9.SetSuccessor(op11);
